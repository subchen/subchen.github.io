...
;(function()
{
	...
	function Brush()
	{
		var keywords =	'define set put if else elseif end for include break continue stop mixin import debug';
	...
	SyntaxHighlighter.brushes.jetx = Brush;
...
(function() {
  var API_DATA_KEY, API_NAME, API_SELECTOR;
...
(function() {
  ...
  jetbrick.api.ScrollToTop = (function() {

    function ScrollToTop(dom, options) {
      var _this = this;
      this.dom = dom;
      this.options = $.extend({}, jetbrick.api.ScrollToTop.defaults, this.dom.data(), options);
      if (this.dom.is('body')) {
        this.dom = $("<img src='" + this.options.image + "' title='回到顶部' />");
    ...
    ScrollToTop.prototype.scrollup = function() {
      var dest, top;
      top = 0;
      if (this.options.dest) {
        dest = $(this.options.dest);
        top = dest.length === 0 ? 0 : dest.offset().top;
      }
    ...
    ScrollToTop.prototype.toggleHandler = function() {
      var show;
      show = $(window).scrollTop() >= this.options.from;
      if (show && !this.show) {
