...
(function(){jetbrick.webroot=function(){var a;if(jetbrick.webroot.cache){return jetbrick.webroot.cache;}a=".";$("script[src*=jetbrick]").each(function(){var b;b=this.src;if(b.endsWith(".js")){a=b.beforeLast(b,"/");return false;}});if(a.endsWith("/js")){a=a.beforeLast("/js");}if(a.endsWith("/share")){a=a.beforeLast(a,"/share");}if(a.endsWith("/static")){a=a.beforeLast(a,"/static");}return jetbrick.webroot.cache=a;};$.fn.effectiveToggle=function(d,a,e,b){var c;if(d==null){d="default";}if(d==="default"){c=a;}else{if(d==="fade"){if(a==="show"){c="fadeIn";}if(a==="hide"){c="fadeOut";}if(a==="toggle"){c="fadeToggle";}}else{if(d==="slide"){if(a==="show"){c="slideDown";}if(a==="hide"){c="slideUp";}if(a==="toggle"){c="slideToggle";}}}}return $.fn[c].call(this,e,b);};$.fn.outerHTML=function(){var b,d,g,a,c,i,e,h,f;if(this.length===0){return"";}d=this[0];g=d.outerHTML;if(g){return g;}c=d.tagName.toLowerCase();g="<"+c;f=d.attributes;for(e=0,h=f.length;e<h;e++){b=f[e];a=b.nodeName;i=b.nodeValue;if(i){i=i.replace("'","\\'");}g+=" "+a+"='"+i+"'";}return g+=">"+(this.html())+"</"+c+">";};jetbrick.zIndex=function(){var a,d,c,f,e,b;c=document.getElementsByTagName("*");a=0;for(e=0,b=c.length;e<b;e++){d=c[e];f=(+d.style.zIndex)||0;if(a<f){a=f;}}return a+1;};jetbrick.addQueryString=function(b,a,c){b+=b.indexOf("?")<0?"?":"&";b+=a+"="+jetbrick.asString(c);return b;};jetbrick.redirectUrl=function(a,b){a=jetbrick.addQueryString(a,"_",Math.random());return window.open(a,b||"_self",null,true);};}).call(this);
jetbrick.scrolltop=function(){var b=$('<img src="../static/images/scrolltop.png" />');b.css({display:"none",cursor:"pointer",position:"fixed",right:"60px",bottom:"80px",border:"0 none",margin:0,padding:0,width:"auto",height:"auto"});$("body").append(b);var a=true;$(window).on("scroll resize",function(){if($(window).scrollTop()>40){if(a){b.fadeIn();a=false;}}else{if(!a){b.fadeOut();a=true;}}});b.click(function(){$("body,html").animate({scrollTop:0},400);return false;});};$(function(){jetbrick.scrolltop();});
