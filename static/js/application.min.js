...
jetbrick.scrolltop=function(){var a=$('<img src="../static/images/scrolltop.png" />');a.css({display:"none",cursor:"pointer",position:"fixed",right:"60px",bottom:"80px",border:"0 none",margin:0,padding:0,width:"auto",height:"auto"});$("body").append(a);$(window).on("scroll resize",function(){if($(window).scrollTop()>40){if(a.is(":hidden")){a.fadeIn();}}else{if(!a.is(":hidden")){a.fadeOut();}}});a.click(function(){$("body,html").animate({scrollTop:0},400);return false;});};$(function(){jetbrick.scrolltop();});
